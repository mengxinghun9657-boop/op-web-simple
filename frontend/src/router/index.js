...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'apiserver/config', name: 'APIServerConfigPage', component: () => import('@/components/config/APIServerConfig.vue'), meta: { title: 'APIServer告警配置' } },
      { path: 'apiserver/monitoring', name: 'APIServerMonitoring', component: () => import('@/views/apiserver/APIServerMonitoring.vue'), meta: { title: 'APIServer监控总览' } },
      { path: 'apiserver/alerts', name: 'APIServerAlerts', component: () => import('@/views/apiserver/APIServerAlerts.vue'), meta: { title: 'APIServer告警列表' } },
      { path: 'gpu-monitoring/has-inspection', name: 'GPUHasInspection', component: () => import('@/views/gpu-monitoring/HASInspection.vue'), meta: { title: 'HAS自动化巡检' } },
      { path: 'gpu-monitoring/grafana-dashboard', name: 'GPUGrafanaDashboard', component: () => import('@/views/gpu-monitoring/GrafanaDashboard.vue'), meta: { title: 'Grafana监控仪表盘' } },
      { path: 'gpu-monitoring/bottom-card-time', name: 'GPUBottomCardTime', component: () => import('@/views/gpu-monitoring/BottomCardTime.vue'), meta: { title: 'bottom卡时数据' } },
      { path: 'cce-monitoring/dashboard', name: 'CCEMonitoringDashboard', component: () => import('@/views/cce-monitoring/CCEMonitoringDashboard.vue'), meta: { title: 'CCE集群实时监控' } },
